...
INSERT INTO scenarios
    (id, name, description, field_ids)
VALUES ('f84dcf0c-4bde-460b-9139-ea76e3694267',
        'Scenario 001 - The Network Impact Propagation KPI measures how disruptions in one part of the railway network affect the overall system, including delay propagation and congestion spillover. This KPI helps evaluate the cascading effects of local disturbances and the efficiency of AI-assisted re-scheduling in mitigating these effects. ',
        ...
        array['87bc91e6-e253-47a2-a2e9-eb9d48d71403', 'af34304f-6302-44f9-a092-f4949e84b8a0', '452a6a18-12a8-4b11-8f52-676402377775',
...
INSERT INTO fields
        (id, key, description, agg_func, agg_weights)
VALUES ('af34304f-6302-44f9-a092-f4949e84b8a0', 'success_rate_1', 'Secondary scenario score (raw values): success_rate scenario without malfunction', NULL,
        NULL)
        ON CONFLICT(id) DO UPDATE SET key=EXCLUDED.key, description=EXCLUDED.description, agg_func=EXCLUDED.agg_func, agg_weights=EXCLUDED.agg_weights;
...
INSERT INTO fields
        (id, key, description, agg_func, agg_weights)
VALUES ('0804809f-f805-4f0d-a7ec-a72cbcf4454a', 'success_rate_2', 'Secondary scenario score (raw values): success_rate scenario without malfunction', NULL,
        NULL)
        ON CONFLICT(id) DO UPDATE SET key=EXCLUDED.key, description=EXCLUDED.description, agg_func=EXCLUDED.agg_func, agg_weights=EXCLUDED.agg_weights;
