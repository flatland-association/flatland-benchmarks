...
INSERT INTO tests
    (id, name, description, field_ids, scenario_ids, loop, queue)
VALUES ('6ff3c588-357c-41a6-a45a-2bd946b158c8', 'KPI-DF-016: Delay reduction efficiency (Railway)',
        ...
        array['0c1be4b0-c30f-4e38-a698-3b141181ede6']::uuid[], array['bb6302f1-0dc2-43ed-976b-4e5d3126006a', '02e163b8-d8a3-44cb-9fb0-65501dfa35b7',
        '01a82553-8d2c-4f84-94df-ccb9f3250734', '3b68eeb2-96f6-4a87-8a2f-5decaf3cb3f0', '2b4b92d2-6871-4c20-ad58-11dc51718379',
        '9b603e03-3e2e-4366-8127-96307d3b2ce1', '5832961b-942f-4d33-8614-c6dd4861ef46', '45b93b12-57cc-40ff-b277-82de8ceaec32',
        '7b42a1cc-ce70-4d9a-804f-ac9027a1ee48', '25f59eeb-3baf-4668-bdb1-2beb577fbf73', 'f262ffb3-86b9-4db8-8657-f4a96915cb83',
        '14a20672-ea9c-4205-961a-4f2a3585eea2', '4223ef16-0a01-404d-8024-5a656203d3f8', '10ee5c39-9ae9-4e58-bdc8-8a449887574d',
        'd4b12805-017e-46d9-8fe7-220569a21477', 'a7a37c14-b2a7-471c-9ed2-af90ee502d39', 'd238a30f-2f16-4e12-83a6-fcf779cd7115',
        '9eb9657e-5c48-461a-a680-7fae151f6800', '2bb4384c-1119-4756-a2ad-fc2e5c00f952', '03ffcc01-b691-406f-ac53-5d13e9328175',
        'f3ee3bb9-3328-450a-98fb-63692042134f', 'f7509133-3083-4454-a963-95302eb66764', 'd271e605-1b68-4609-884c-0e6b2417980a',
        'f9b8c0b3-0968-4324-9b92-35063c49def2', '05eeb2ea-67fe-405e-b630-43f382dbf246']::uuid[], 'CLOSED', 'Railway')
    ON CONFLICT(id) DO UPDATE SET name=EXCLUDED.name, description=EXCLUDED.description, field_ids=EXCLUDED.field_ids, scenario_ids=EXCLUDED.scenario_ids, loop=EXCLUDED.loop, queue=EXCLUDED.queue;
