    ...
    data = gen_flatland_sql(
      ...
      suite_contents=json.dumps({
        ...
        'tabs': [{'title': 'What is Flatland?',
                 ...
                 {'title': 'Contact',
                  'text': '<p>Join our <a href="https://matrix.to/#/#ecml-real-world-baselines-challenge-2026:matrix.org" target="_blank">Matrix-Space</a> so you don\'t miss any notifications about the competition and to connect to us and to other participants.</p><p>Or get in touch with us by e-mail <a href="mailto:competition@flatland-association.org">competition@flatland-association.org</a></p>'}]}
      ),
