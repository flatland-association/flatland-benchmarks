...
INSERT INTO benchmark_definitions
    ...
    VALUES ('becc32fe-d993-44ba-aaa9-a31bde3e2a0a', 'Warm-up round', 'The warm-up round runs from November 10th, 2025 - November 28th, 2025', array['5b6dc263-0377-4dc0-a873-16b3b35abf44', '53128eb5-1991-42fe-93ca-6e8f16385828']::uuid[], array['ee1675ff-3e6a-4f19-a371-3b60533f50f5', 'ad15a918-f020-4bf2-af35-f37a07158c77', '74d15655-bbd5-4e3f-b84a-756172a9fae2', 'cccc9193-31b1-49f1-8c45-21453f1831f0', 'bb672a97-2278-4000-a450-ee3e0054d5f6', '3ef9d9a4-e8a6-4de0-8c93-15db75c96160', '6777b4aa-f2f4-4712-8c84-00d3f9ceaea6', 'bd542182-871e-499d-8de5-1e3f98850715', '8d14cc5a-bdba-494e-a4ba-551f8c169736', '52840e5d-b6ab-4855-aff1-65ee4e3aa239', 'a94944df-3aa8-46dc-9e15-7237a75ecf80', 'a86fdf12-b186-4db9-99f9-252248cd0321', '2cf91405-d037-4742-a9ff-7c0023d4f86e', '6610f499-7366-4271-ba1e-5613c3318a94', 'e7f1d751-c875-4857-b1d2-072cbb72b383']::uuid[])
...
INSERT INTO test_definitions
    (id, name, description, field_ids, scenario_ids, loop, queue)
    VALUES ('ad15a918-f020-4bf2-af35-f37a07158c77', 'Test 1', 'Test 1: 7 agents,  30x30, 2', array['3c5df517-5bfa-42ca-96ed-f652711e88a8', '0aceae40-b02a-4ed6-85b9-50e61ebd70e3']::uuid[], array['92fea6d9-610f-4344-af4f-bfdf4e294f63']::uuid[], 'CLOSED', NULL)
    ON CONFLICT(id) DO UPDATE SET name=EXCLUDED.name, description=EXCLUDED.description, field_ids=EXCLUDED.field_ids, scenario_ids=EXCLUDED.scenario_ids, loop=EXCLUDED.loop, queue=EXCLUDED.queue;
...
INSERT INTO test_definitions
    (id, name, description, field_ids, scenario_ids, loop, queue)
    VALUES ('74d15655-bbd5-4e3f-b84a-756172a9fae2', 'Test 2', 'Test 2: 20 agents,  30x30, 3', array['3c5df517-5bfa-42ca-96ed-f652711e88a8', '0aceae40-b02a-4ed6-85b9-50e61ebd70e3']::uuid[], array['92fea6d9-610f-4344-af4f-bfdf4e294f63']::uuid[], 'CLOSED', NULL)
    ON CONFLICT(id) DO UPDATE SET name=EXCLUDED.name, description=EXCLUDED.description, field_ids=EXCLUDED.field_ids, scenario_ids=EXCLUDED.scenario_ids, loop=EXCLUDED.loop, queue=EXCLUDED.queue;
...
INSERT INTO test_definitions
    (id, name, description, field_ids, scenario_ids, loop, queue)
    VALUES ('cccc9193-31b1-49f1-8c45-21453f1831f0', 'Test 3', 'Test 3: 50 agents,  35x30, 3', array['3c5df517-5bfa-42ca-96ed-f652711e88a8', '0aceae40-b02a-4ed6-85b9-50e61ebd70e3']::uuid[], array['92fea6d9-610f-4344-af4f-bfdf4e294f63']::uuid[], 'CLOSED', NULL)
    ON CONFLICT(id) DO UPDATE SET name=EXCLUDED.name, description=EXCLUDED.description, field_ids=EXCLUDED.field_ids, scenario_ids=EXCLUDED.scenario_ids, loop=EXCLUDED.loop, queue=EXCLUDED.queue;
...
INSERT INTO test_definitions
    (id, name, description, field_ids, scenario_ids, loop, queue)
    VALUES ('bb672a97-2278-4000-a450-ee3e0054d5f6', 'Test 4', 'Test 4: 80 agents,  30x35, 5', array['3c5df517-5bfa-42ca-96ed-f652711e88a8', '0aceae40-b02a-4ed6-85b9-50e61ebd70e3']::uuid[], array['92fea6d9-610f-4344-af4f-bfdf4e294f63']::uuid[], 'CLOSED', NULL)
    ON CONFLICT(id) DO UPDATE SET name=EXCLUDED.name, description=EXCLUDED.description, field_ids=EXCLUDED.field_ids, scenario_ids=EXCLUDED.scenario_ids, loop=EXCLUDED.loop, queue=EXCLUDED.queue;
...
INSERT INTO test_definitions
    (id, name, description, field_ids, scenario_ids, loop, queue)
    VALUES ('3ef9d9a4-e8a6-4de0-8c93-15db75c96160', 'Test 5', 'Test 5: 80 agents,  35x45, 7', array['3c5df517-5bfa-42ca-96ed-f652711e88a8', '0aceae40-b02a-4ed6-85b9-50e61ebd70e3']::uuid[], array['92fea6d9-610f-4344-af4f-bfdf4e294f63']::uuid[], 'CLOSED', NULL)
    ON CONFLICT(id) DO UPDATE SET name=EXCLUDED.name, description=EXCLUDED.description, field_ids=EXCLUDED.field_ids, scenario_ids=EXCLUDED.scenario_ids, loop=EXCLUDED.loop, queue=EXCLUDED.queue;
...
INSERT INTO test_definitions
    (id, name, description, field_ids, scenario_ids, loop, queue)
    VALUES ('6777b4aa-f2f4-4712-8c84-00d3f9ceaea6', 'Test 6', 'Test 6: 80 agents,  60x40, 9', array['3c5df517-5bfa-42ca-96ed-f652711e88a8', '0aceae40-b02a-4ed6-85b9-50e61ebd70e3']::uuid[], array['92fea6d9-610f-4344-af4f-bfdf4e294f63']::uuid[], 'CLOSED', NULL)
    ON CONFLICT(id) DO UPDATE SET name=EXCLUDED.name, description=EXCLUDED.description, field_ids=EXCLUDED.field_ids, scenario_ids=EXCLUDED.scenario_ids, loop=EXCLUDED.loop, queue=EXCLUDED.queue;
...
INSERT INTO test_definitions
    (id, name, description, field_ids, scenario_ids, loop, queue)
    VALUES ('bd542182-871e-499d-8de5-1e3f98850715', 'Test 7', 'Test 7: 80 agents,  40x60, 13', array['3c5df517-5bfa-42ca-96ed-f652711e88a8', '0aceae40-b02a-4ed6-85b9-50e61ebd70e3']::uuid[], array['92fea6d9-610f-4344-af4f-bfdf4e294f63']::uuid[], 'CLOSED', NULL)
    ON CONFLICT(id) DO UPDATE SET name=EXCLUDED.name, description=EXCLUDED.description, field_ids=EXCLUDED.field_ids, scenario_ids=EXCLUDED.scenario_ids, loop=EXCLUDED.loop, queue=EXCLUDED.queue;
...
INSERT INTO test_definitions
    (id, name, description, field_ids, scenario_ids, loop, queue)
    VALUES ('8d14cc5a-bdba-494e-a4ba-551f8c169736', 'Test 8', 'Test 8: 80 agents,  60x60, 17', array['3c5df517-5bfa-42ca-96ed-f652711e88a8', '0aceae40-b02a-4ed6-85b9-50e61ebd70e3']::uuid[], array['92fea6d9-610f-4344-af4f-bfdf4e294f63']::uuid[], 'CLOSED', NULL)
    ON CONFLICT(id) DO UPDATE SET name=EXCLUDED.name, description=EXCLUDED.description, field_ids=EXCLUDED.field_ids, scenario_ids=EXCLUDED.scenario_ids, loop=EXCLUDED.loop, queue=EXCLUDED.queue;
...
INSERT INTO test_definitions
    (id, name, description, field_ids, scenario_ids, loop, queue)
    VALUES ('52840e5d-b6ab-4855-aff1-65ee4e3aa239', 'Test 9', 'Test 9: 100 agents,  120x80, 21', array['3c5df517-5bfa-42ca-96ed-f652711e88a8', '0aceae40-b02a-4ed6-85b9-50e61ebd70e3']::uuid[], array['92fea6d9-610f-4344-af4f-bfdf4e294f63']::uuid[], 'CLOSED', NULL)
    ON CONFLICT(id) DO UPDATE SET name=EXCLUDED.name, description=EXCLUDED.description, field_ids=EXCLUDED.field_ids, scenario_ids=EXCLUDED.scenario_ids, loop=EXCLUDED.loop, queue=EXCLUDED.queue;
...
INSERT INTO test_definitions
    (id, name, description, field_ids, scenario_ids, loop, queue)
    VALUES ('a94944df-3aa8-46dc-9e15-7237a75ecf80', 'Test 10', 'Test 10: 100 agents,  80x100, 25', array['3c5df517-5bfa-42ca-96ed-f652711e88a8', '0aceae40-b02a-4ed6-85b9-50e61ebd70e3']::uuid[], array['92fea6d9-610f-4344-af4f-bfdf4e294f63']::uuid[], 'CLOSED', NULL)
    ON CONFLICT(id) DO UPDATE SET name=EXCLUDED.name, description=EXCLUDED.description, field_ids=EXCLUDED.field_ids, scenario_ids=EXCLUDED.scenario_ids, loop=EXCLUDED.loop, queue=EXCLUDED.queue;
...
INSERT INTO test_definitions
    (id, name, description, field_ids, scenario_ids, loop, queue)
    VALUES ('a86fdf12-b186-4db9-99f9-252248cd0321', 'Test 11', 'Test 11: 200 agents,  100x100, 29', array['3c5df517-5bfa-42ca-96ed-f652711e88a8', '0aceae40-b02a-4ed6-85b9-50e61ebd70e3']::uuid[], array['92fea6d9-610f-4344-af4f-bfdf4e294f63']::uuid[], 'CLOSED', NULL)
    ON CONFLICT(id) DO UPDATE SET name=EXCLUDED.name, description=EXCLUDED.description, field_ids=EXCLUDED.field_ids, scenario_ids=EXCLUDED.scenario_ids, loop=EXCLUDED.loop, queue=EXCLUDED.queue;
...
INSERT INTO test_definitions
    (id, name, description, field_ids, scenario_ids, loop, queue)
    VALUES ('2cf91405-d037-4742-a9ff-7c0023d4f86e', 'Test 12', 'Test 12: 200 agents,  150x150, 33', array['3c5df517-5bfa-42ca-96ed-f652711e88a8', '0aceae40-b02a-4ed6-85b9-50e61ebd70e3']::uuid[], array['92fea6d9-610f-4344-af4f-bfdf4e294f63']::uuid[], 'CLOSED', NULL)
    ON CONFLICT(id) DO UPDATE SET name=EXCLUDED.name, description=EXCLUDED.description, field_ids=EXCLUDED.field_ids, scenario_ids=EXCLUDED.scenario_ids, loop=EXCLUDED.loop, queue=EXCLUDED.queue;
...
INSERT INTO test_definitions
    (id, name, description, field_ids, scenario_ids, loop, queue)
    VALUES ('6610f499-7366-4271-ba1e-5613c3318a94', 'Test 13', 'Test 13: 400 agents,  150x150, 37', array['3c5df517-5bfa-42ca-96ed-f652711e88a8', '0aceae40-b02a-4ed6-85b9-50e61ebd70e3']::uuid[], array['92fea6d9-610f-4344-af4f-bfdf4e294f63']::uuid[], 'CLOSED', NULL)
    ON CONFLICT(id) DO UPDATE SET name=EXCLUDED.name, description=EXCLUDED.description, field_ids=EXCLUDED.field_ids, scenario_ids=EXCLUDED.scenario_ids, loop=EXCLUDED.loop, queue=EXCLUDED.queue;
...
INSERT INTO test_definitions
    (id, name, description, field_ids, scenario_ids, loop, queue)
    VALUES ('e7f1d751-c875-4857-b1d2-072cbb72b383', 'Test 14', 'Test 14: 425 agents,  158x158, 41', array['3c5df517-5bfa-42ca-96ed-f652711e88a8', '0aceae40-b02a-4ed6-85b9-50e61ebd70e3']::uuid[], array['92fea6d9-610f-4344-af4f-bfdf4e294f63']::uuid[], 'CLOSED', NULL)
    ON CONFLICT(id) DO UPDATE SET name=EXCLUDED.name, description=EXCLUDED.description, field_ids=EXCLUDED.field_ids, scenario_ids=EXCLUDED.scenario_ids, loop=EXCLUDED.loop, queue=EXCLUDED.queue;
