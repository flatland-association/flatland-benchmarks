...
def test_containers_fixture_running_time_limit():
  ...
  basic = DockerCompose(context="../..", profiles=["full"], env_file=".env.test.runningtimelimit")
...
@pytest.mark.usefixtures("test_containers_fixture_running_time_limit")
@pytest.mark.parametrize(
  ...
  [
    (["4ecdb9f4-e2ff-41ff-9857-abe649c19c50", "5206f2ee-d0a9-405b-8da3-93625e169811"],
     ["4ecdb9f4-e2ff-41ff-9857-abe649c19c50", "5206f2ee-d0a9-405b-8da3-93625e169811"], [[None, None], [None, None, None]],
     [None, None],
...
def test_running_time_limit(expected_test_ids, tests: List[str], expected_primary_scenario_scores: List[List[float]],
